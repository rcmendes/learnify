...
//data class Asset(val name: String, val description: String? = null, val url: String, val type: com.ciriguela.learnify.gamedesign.api.persistence.AssetType, val category: Category, val databaseInfo: DatabaseInfo)
//
...
//
//data class NewAsset(val name: String, val description: String? = null, val url: String, val type: com.ciriguela.learnify.gamedesign.api.persistence.AssetType, val category: Category)
